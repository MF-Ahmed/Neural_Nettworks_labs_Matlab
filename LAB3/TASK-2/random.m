...
function [spec,sens,spec1,sens1,i,j] = random(N,target_dataset,X)
...
tar_trainset = target_dataset(1:end,:); 
new_target=zeros(N,1);
%Test Set
ind  = round(rand(1,N)*size(X,1));
tar_testset = target_dataset(ind,:);
