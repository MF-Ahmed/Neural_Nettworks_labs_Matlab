...
clc;clear all;
close all;
X=csvread('dataset1.txt');  % comma seperated values read
s=size(X);
error=0;
...
figure;
plot(avg_errors,'*r')
title('1st Training set Average errors');
% Result
% In this dataset we have fortunately found many linearly
% seperable hyper planes. Hence the dataset is Linearly seperable
